...
func TestCreateUserRejectsAdminPromotion(t *testing.T) {
	service := NewService(fakeSecrets{pocketid.ManagementCredentialField: "unused"}, "http://127.0.0.1", nil)
...
func TestClientVaultPathUsesDeclarativeResource(t *testing.T) {
	service := NewService(fakeSecrets{pocketid.ManagementCredentialField: "unused"}, "http://127.0.0.1", fakeClientRegistry{{
...
func TestClientVaultPathRejectsAmbiguousDeclaration(t *testing.T) {
	...
	service := NewService(fakeSecrets{pocketid.ManagementCredentialField: "unused"}, "http://127.0.0.1", registry)
